...
flowchart TB
    ...
    A["✅ Per-sector market analysis (8 pages, 2026)"]:::live
    B["✅ EQMS supplier-audit industry study (8 pages, 2026)"]:::live
    C["✅ Quality software research paper (4 pages, 2026)"]:::live
    D["⏳ AI in regulated industries whitepaper"]:::plan
    E["⏳ EQMS landscape 2027 (annual)"]:::plan
    F["⏳ Standards convergence (post ISO 9001:2026)"]:::plan
    G["⏳ Customer case studies (post-first-3)"]:::plan
```
...
flowchart LR
    ...
    A["Topic ideation<br/>(quarterly planning)"]:::step
    B["Outline +<br/>source list"]:::step
    C["Draft<br/>(founder lead)"]:::step
    D["SME review<br/>(pharma consultant +<br/>ex-regulator if avail)"]:::step
    E["Edit + design<br/>(self today;<br/>designer M9+)"]:::step
    F["Publish:<br/>PDF + landing page<br/>+ LinkedIn promo"]:::step
    G["Measure:<br/>downloads + cites +<br/>conversation starts"]:::step
