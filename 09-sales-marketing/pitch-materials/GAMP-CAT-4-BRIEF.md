...
1. **"What's Hawkeye's GAMP classification?"**
2. **"What's our validation burden — and what does Hawkeye provide to reduce it?"**
...
> 📜 **Hawkeye is a GAMP 5 Category 4 — Configured Product**
...
| 2 | **Pre-Executed IQ/OQ Scripts (against vendor product)** | Proof Hawkeye's product as supplied installs and operates per documented FRS. You leverage this as evidence; you only re-execute IQ in your tenant (smoke tests) and author OQ for your configuration. |
...
| 4 | **Pre-Populated Traceability Matrix** | Every Hawkeye product feature already mapped to FRS section + product IQ/OQ test. You extend with rows for your config. Saves days of trace-matrix authoring. |
...
flowchart LR
    ...
    subgraph V["HAWKEYE PROVIDES (you leverage)"]
...
**Reading the diagram:** Hawkeye produces 7 categories of vendor-side evidence and templates. You leverage them and author 8 customer-specific items. **That ratio is what makes Cat 4 a ~60% effort reduction vs Cat 5.**
...
| Activity | Effort |
|---|---|
| URS authoring (using Hawkeye template) | 2 days |
...
Cat 4 isn't enough on its own — it has to deliver against the regulatory standards your auditor cares about. Hawkeye does:
...
**Q: "Do we have to re-validate after every Hawkeye release?"**
...
A: Source-code review is a Cat 5 obligation, not Cat 4. Regulators accept vendor SDLC evidence + supplier qualification for Cat 4 products. If specifically requested, Hawkeye can arrange a secure on-site review under NDA — but this is rare for Cat 4.

**Q: "Can we audit Hawkeye?"**
A: Yes — annual right-to-audit (remote default; on-site at customer cost). Hawkeye maintains a Pre-Prepared Audit Pack so a remote audit typically takes 4–6 hours of customer auditor time vs 2–3 days from cold.
...
**Q: "What about FDA CSA — is Hawkeye ready?"**
A: Yes — CSA was finalized Sept 2025 and re-issued Feb 2026. Hawkeye's Validation Accelerator Package was designed specifically for vendor-evidence-leveraged customer assurance, which is exactly what CSA's risk-based framework encourages.
...
| Week 7 of PoC | Validation Summary Report (Hawkeye-produced, supports your customer-side VSR) |
...
*Hawkeye Transact Pvt. Ltd. · GAMP 5 Category 4 Compliance — Customer Brief · v1.0 · 2026-06-05 · Confidential*
